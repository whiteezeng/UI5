 ...
 * @param {sap.ui.base.EventProvider} oControlEvent.getSource
 * @param {object} oControlEvent.getParameters
 * @param {string} oControlEvent.getParameters.fileName The filename, which is longer than specified by the value of the property <code>maximumFilenameLength</code>.
 * @public
 * 
 */
 ...
 * @param {object} oControlEvent.getParameters
 * @param {string} oControlEvent.getParameters.fileName The name of a file to be uploaded.
 * @param {object[]} oControlEvent.getParameters.requestHeaders Http-Request-Headers.
 * 
 ...
 * @param {object} oControlEvent.getParameters
 * @param {string} oControlEvent.getParameters.fileName The name of a file to be uploaded.
 * @param {string} oControlEvent.getParameters.response Response message which comes from the server.
 * 
 ...
 * @param {string} oControlEvent.getParameters.readyStateXHR ReadyState of the XHR request.
 * 
 ...
 * @param {string} oControlEvent.getParameters.status Status of the XHR request.
 * 
 * Required for receiving a <code>status</code> is to set the property <code>sendXHR</code> to true.
 * This property is not supported by Internet Explorer 9.
 * @param {string} oControlEvent.getParameters.responseRaw Http-Response which comes from the server.
 * 
 * Required for receiving <code>responseRaw</code> is to set the property <code>sendXHR</code> to true.
 * 
 * This property is not supported by Internet Explorer 9.
 * @param {object} oControlEvent.getParameters.headers Http-Response-Headers which come from the server.
 * 
 ...
 * @param {float} oControlEvent.getParameters.loaded The number of bytes of the file which have been uploaded by the time the event was fired.
 * @param {float} oControlEvent.getParameters.total The total size of the file to be uploaded in bytes.
 * @param {string} oControlEvent.getParameters.fileName The name of a file to be uploaded.
 * @param {object[]} oControlEvent.getParameters.requestHeaders Http-Request-Headers.
 * 
 * Required for receiving <code>requestHeaders</code> is to set the property <code>sendXHR</code> to true.
 ...
 * 
 */
sap.ui.unified.FileUploader.prototype.addAriaDescribedBy = function(vAriaDescribedBy) { return new sap.ui.unified.FileUploader(); };
 ...
 * 
 */
sap.ui.unified.FileUploader.prototype.addAriaLabelledBy = function(vAriaLabelledBy) { return new sap.ui.unified.FileUploader(); };
 ...
 * 
 * @param {object} [mParameters] Parameters to pass along with the event
 * @param {string} [mParameters.fileName] The filename, which is longer than specified by the value of the property <code>maximumFilenameLength</code>.
 * 
 * @returns {sap.ui.unified.FileUploader} Reference to <code>this</code> in order to allow method chaining
 * @protected
 * @since 1.24.0
 ...
 * @param {object} [mParameters] Parameters to pass along with the event
 * @param {string} [mParameters.fileName] The name of a file to be uploaded.
 * @param {object[]} [mParameters.requestHeaders] Http-Request-Headers.
 * 
 * Required for receiving <code>requestHeader</code> is to set the property <code>sendXHR</code> to true.
 * This property is not supported by Internet Explorer 9.
 * 
 ...
 * @param {object} [mParameters] Parameters to pass along with the event
 * @param {string} [mParameters.fileName] The name of a file to be uploaded.
 * @param {string} [mParameters.response] Response message which comes from the server.
 * 
 * On the server side this response has to be put within the &quot;body&quot; tags of the response
 * document of the iFrame. It can consist of a return code and an optional message. This does not
 * work in cross-domain scenarios.
 * @param {string} [mParameters.readyStateXHR] ReadyState of the XHR request.
 * 
 * Required for receiving a <code>readyStateXHR</code> is to set the property <code>sendXHR</code>
 * to true. This property is not supported by Internet Explorer 9.
 * @param {string} [mParameters.status] Status of the XHR request.
 * 
 * Required for receiving a <code>status</code> is to set the property <code>sendXHR</code> to true.
 * This property is not supported by Internet Explorer 9.
 * @param {string} [mParameters.responseRaw] Http-Response which comes from the server.
 * 
 * Required for receiving <code>responseRaw</code> is to set the property <code>sendXHR</code> to true.
 * 
 * This property is not supported by Internet Explorer 9.
 * @param {object} [mParameters.headers] Http-Response-Headers which come from the server.
 * 
 * Provided as a JSON-map, i.e. each header-field is reflected by a property in the <code>headers</code>
 * object, with the property value reflecting the header-field's content.
 * 
 ...
 * @param {float} [mParameters.loaded] The number of bytes of the file which have been uploaded by the time the event was fired.
 * @param {float} [mParameters.total] The total size of the file to be uploaded in bytes.
 * @param {string} [mParameters.fileName] The name of a file to be uploaded.
 * @param {object[]} [mParameters.requestHeaders] Http-Request-Headers.
 * 
 * Required for receiving <code>requestHeaders</code> is to set the property <code>sendXHR</code> to true.
 ...
 * 
 */
sap.ui.unified.FileUploader.prototype.getAriaDescribedBy = function() { return new Array(); };
 ...
 * 
 */
sap.ui.unified.FileUploader.prototype.getAriaLabelledBy = function() { return new Array(); };
 ...
 * 
 */
sap.ui.unified.FileUploader.prototype.removeAllAriaDescribedBy = function() { return new Array(); };
 ...
 * 
 */
sap.ui.unified.FileUploader.prototype.removeAllAriaLabelledBy = function() { return new Array(); };
 ...
 * 
 */
sap.ui.unified.FileUploader.prototype.removeAriaDescribedBy = function(vAriaDescribedBy) { return new sap.ui.core.ID(); };
 ...
 * 
 */
sap.ui.unified.FileUploader.prototype.removeAriaLabelledBy = function(vAriaLabelledBy) { return new sap.ui.core.ID(); };
 ...
 * 
 */
sap.ui.unified.Menu.prototype.openAsContextMenu = function(oEvent,oOpenerRef) {  };
