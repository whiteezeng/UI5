 ...
 * 
 */
sap.tnt.NavigationList.prototype.getSelectedKey = function() { return ""; };
 ...
 * 
 */
sap.tnt.NavigationList.prototype.setSelectedItem = function(selectedItem) { return new sap.tnt.NavigationList(); };
 ...
 * 
 */
sap.tnt.NavigationList.prototype.setSelectedKey = function(selectedKey) { return new sap.tnt.NavigationList(); };
 ...
 * 
 */
sap.tnt.SideNavigation.prototype.getSelectedKey = function() { return ""; };
 ...
 * 
 */
sap.tnt.SideNavigation.prototype.setSelectedItem = function(selectedItem) { return new sap.tnt.SideNavigation(); };
 ...
 * 
 */
sap.tnt.SideNavigation.prototype.setSelectedKey = function(selectedKey) { return new sap.tnt.SideNavigation(); };
 ...
 * 
 */
sap.tnt.ToolPage.prototype.getHeader = function() { return new sap.tnt.IToolHeader(); };
 ...
 * @param {sap.tnt.IToolHeader} oHeader The header to set
 * @returns {sap.tnt.ToolPage} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
