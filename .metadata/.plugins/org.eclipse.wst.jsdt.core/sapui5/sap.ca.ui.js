 ...
 * <li>{@link #getPictureAlign pictureAlign} : sap.ui.core.TextAlign (default: Left)</li>
 * <li>{@link #getItemSize itemSize} : int (default: 64)</li>
 * <li>{@link #getCompression compression} : string (default: low)</li>
 * </ul>
 * </li>
 * <li>Aggregations
 * <ul>
 * <li>{@link #getPictures pictures} : sap.ca.ui.PictureItem[]</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
 * <li>{@link #event:show show} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * <li>{@link #event:pictureAdded pictureAdded} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * <li>{@link #event:maxPictureLimitReached maxPictureLimitReached} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * <li>{@link #event:imageUploadFailed imageUploadFailed} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * <li>{@link #event:fileNotSupported fileNotSupported} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * </ul>
 * </li>
 * </ul>
 * 
 ...
 * @returns {sap.ca.ui.AddPicture} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:fileNotSupported fileNotSupported} event of this <code>sap.ca.ui.AddPicture</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.AddPicture</code> itself.
 * 
 * Image upload failed, only supports image format files
 * 
 * @param {object}
 ...
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ca.ui.AddPicture</code> itself
 * 
 * @returns {sap.ca.ui.AddPicture} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:imageUploadFailed imageUploadFailed} event of this <code>sap.ca.ui.AddPicture</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.AddPicture</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:maxPictureLimitReached maxPictureLimitReached} event of this <code>sap.ca.ui.AddPicture</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.AddPicture</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:pictureAdded pictureAdded} event of this <code>sap.ca.ui.AddPicture</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.AddPicture</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:show show} event of this <code>sap.ca.ui.AddPicture</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.AddPicture</code> itself.
 * 
 ...
 * 
 */
sap.ca.ui.AddPicture.prototype.bindPictures = function(oBindingInfo) { return new sap.ca.ui.AddPicture(); };
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:fileNotSupported fileNotSupported} event of this <code>sap.ca.ui.AddPicture</code>.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:imageUploadFailed imageUploadFailed} event of this <code>sap.ca.ui.AddPicture</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:maxPictureLimitReached maxPictureLimitReached} event of this <code>sap.ca.ui.AddPicture</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:pictureAdded pictureAdded} event of this <code>sap.ca.ui.AddPicture</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:show show} event of this <code>sap.ca.ui.AddPicture</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * @param {any} [mParameters.fileNames] An array containing the file names that are not supported
 * 
 * @returns {sap.ca.ui.AddPicture} Reference to <code>this</code> in order to allow method chaining
 * @protected
 * 
 */
sap.ca.ui.AddPicture.prototype.fireFileNotSupported = function(mParameters) { return new sap.ca.ui.AddPicture(); };
 ...
 * 
 */
sap.ca.ui.AddPicture.prototype.fireImageUploadFailed = function(mParameters) { return new sap.ca.ui.AddPicture(); };
 ...
 * 
 */
sap.ca.ui.AddPicture.prototype.fireMaxPictureLimitReached = function(mParameters) { return new sap.ca.ui.AddPicture(); };
 ...
 * 
 */
sap.ca.ui.AddPicture.prototype.firePictureAdded = function(mParameters) { return new sap.ca.ui.AddPicture(); };
 ...
 * 
 */
sap.ca.ui.AddPicture.prototype.fireShow = function(mParameters) { return new sap.ca.ui.AddPicture(); };
 ...
 * @returns {string} Value of property <code>buttonPageType</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {string} Value of property <code>compression</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {int} Value of property <code>itemSize</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {int} Value of property <code>maxPictureNumber</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {sap.ui.core.TextAlign} Value of property <code>pictureAlign</code>
 * 
 * @public
 * 
 */
...
/**
 * Checks for the provided <code>sap.ca.ui.PictureItem</code> in the aggregation {@link #getPictures pictures}.
 ...
 * @returns {sap.ca.ui.PictureItem[]} An array of the removed elements (might be empty)
 * 
 * @public
 * 
 */
 ...
 * @returns {sap.ca.ui.PictureItem} The removed picture or <code>null</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>Left</code>.
 * @param {sap.ui.core.TextAlign} sPictureAlign New value for property <code>pictureAlign</code>
 * @returns {sap.ca.ui.AddPicture} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ca.ui.AddPicture.prototype.setPictureAlign = function(sPictureAlign) { return new sap.ca.ui.AddPicture(); };
 ...
 * List item label
 * 
 * @returns {string} Value of property <code>axis</code>
 * 
 * @public
 * 
 */
 ...
 * List item label
 * 
 * @returns {string} Value of property <code>group</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {sap.ca.ui.charts.BarListItem} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
 ...
 * <li>{@link #getAxisFormatFunction axisFormatFunction} : object</li>
 * </ul>
 * </li>
 * <li>Aggregations
 * <ul>
 ...
 * @returns {sap.ca.ui.charts.BubbleChart} Reference to <code>this</code> in order to allow method chaining
 * 
 ...
 * and enriches it with the information contained in <code>oClassInfo</code>.
 * 
 * <code>oClassInfo</code> might contain the same kind of information as described in {@link sap.ca.ui.charts.Chart.extend}.
 * 
 * @param {string} sClassName Name of the class being created
 * @param {object} [oClassInfo] Object literal with information about the class
 * @param {function} [FNMetaImpl] Constructor function for the metadata object; if not given, it defaults to <code>sap.ui.core.ElementMetadata</code>
 ...
 * 
 * @returns {object} Value of property <code>axisFormatFunction</code>
 * 
 * @deprecated Since version 7.20.0. 
 ...
 * 
 * @returns {any} Value of property <code>axisTooltipFormatString</code>
 * 
 * @deprecated Since version 7.20.0. 
 * This method is deprecated now. Use the plotAreaAxisTooltipFormatter
 * 
 ...
 * 
 * @returns {any} Value of property <code>dataLabelFormat</code>
 * 
 * @deprecated Since version 7.20.0. 
 ...
 * 
 * @returns {object} Value of property <code>labelProperty</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {int} Value of property <code>minimumLabelSize</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {boolean} Value of property <code>showCustomLabels</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>showSizeLegend</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>true</code>.
 * @returns {boolean} Value of property <code>showXAxisLabel</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>true</code>.
 * @returns {boolean} Value of property <code>showYAxisLabel</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>xAxisFixedRange</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {object} Value of property <code>xAxisFormatFunction</code>
 * 
 * @deprecated Since version 7.20.0. 
 ...
 * 
 * @returns {string} Value of property <code>xAxisFormatString</code>
 * 
 * @deprecated Since version 7.20.0. 
 * This method is deprecated now. Use the xAxisLabelFormatter for any formatting of the axis labels
 * 
 ...
 * @returns {float} Value of property <code>xAxisMaxValue</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>0</code>.
 * @returns {float} Value of property <code>xAxisMinValue</code>
 * 
 * @public
 * 
 */
 ...
 * Set x-axis title
 * 
 * @returns {string} Value of property <code>xAxisTitle</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>yAxisFixedRange</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {object} Value of property <code>yAxisFormatFunction</code>
 * 
 * @deprecated Since version 7.20.0. 
 ...
 * 
 * @returns {string} Value of property <code>yAxisFormatString</code>
 * 
 * @deprecated Since version 7.20.0. 
 * This method is deprecated now. Use the yAxisLabelFormatter for any formatting of the axis labels
 * 
 ...
 * 
 * Default value is <code>0</code>.
 * @returns {float} Value of property <code>yAxisMaxValue</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>0</code>.
 * @returns {float} Value of property <code>yAxisMinValue</code>
 * 
 * @public
 * 
 */
 ...
 * Set y-axis title
 * 
 * @returns {string} Value of property <code>yAxisTitle</code>
 * 
 * @public
 * 
 */
 ...
 * <li>{@link #getSelectionMode selectionMode} : sap.ca.ui.charts.ChartSelectionMode (default: Multiple)</li>
 ...
 * <li>Events
 * <ul>
 * <li>{@link #event:selectDataPoint selectDataPoint} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * <li>{@link #event:popoverBeforeOpen popoverBeforeOpen} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:popoverAfterOpen popoverAfterOpen} event of this <code>sap.ca.ui.charts.Chart</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.charts.Chart</code> itself.
 * 
 * Event is fired after the popover is opened
 * 
 * @param {object}
 ...
 *            fnFunction The function to be called when the event occurs
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ca.ui.charts.Chart</code> itself
 * 
 * @returns {sap.ca.ui.charts.Chart} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:popoverBeforeOpen popoverBeforeOpen} event of this <code>sap.ca.ui.charts.Chart</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.charts.Chart</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:selectDataPoint selectDataPoint} event of this <code>sap.ca.ui.charts.Chart</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.charts.Chart</code> itself.
 * 
 ...
 * 
 */
sap.ca.ui.charts.Chart.prototype.bindLabel = function(oBindingInfo) { return new sap.ca.ui.charts.Chart(); };
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:popoverAfterOpen popoverAfterOpen} event of this <code>sap.ca.ui.charts.Chart</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:popoverBeforeOpen popoverBeforeOpen} event of this <code>sap.ca.ui.charts.Chart</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:selectDataPoint selectDataPoint} event of this <code>sap.ca.ui.charts.Chart</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ca.ui.charts.Chart.prototype.firePopoverAfterOpen = function(mParameters) { return new sap.ca.ui.charts.Chart(); };
 ...
 * 
 */
sap.ca.ui.charts.Chart.prototype.firePopoverBeforeOpen = function(mParameters) { return new sap.ca.ui.charts.Chart(); };
 ...
 * 
 */
sap.ca.ui.charts.Chart.prototype.fireSelectDataPoint = function(mParameters) { return new sap.ca.ui.charts.Chart(); };
 ...
 * property.
 * 
 * @returns {object} Value of property <code>advancedChartSettings</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {object} Value of property <code>chartSemanticColorFormatter</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {object} Value of property <code>dataLabelFormatter</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {sap.ui.core.CSSSize} Value of property <code>minShapeSize</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {object} Value of property <code>plotAreaAxisTooltipFormatter</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {sap.ui.core.Control} Value of property <code>popoverFooter</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {object} Value of property <code>popoverFormatter</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {string} Value of property <code>popoverGroupFormatter</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {sap.ui.core.Control} Value of property <code>popoverSubHeader</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>true</code>.
 * @returns {boolean} Value of property <code>secondAxisVisible</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>true</code>.
 * @returns {boolean} Value of property <code>showDataLabel</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>showHoverBackground</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>showTooltip</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>stackedChartWidthEnhancer</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {object} Value of property <code>tooltipFormatter</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {string} Value of property <code>xAxis2LabelFormatter</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {string} Value of property <code>xAxisLabelFormatter</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {string} Value of property <code>yAxis2LabelFormatter</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {string} Value of property <code>yAxisLabelFormatter</code>
 * 
 * @public
 * 
 */
 ...
 * <li>{@link #getSecondDimensionTextPath secondDimensionTextPath} : string (default: )</li>
 * </ul>
 * </li>
 * <li>Aggregations
 * <ul>
 * <li>{@link #getCharts charts} : sap.ui.core.Control[]</li>
 * <li>{@link #getToolBar toolBar} : sap.m.Bar</li>
 * </ul>
 * </li>
 * <li>Associations
 * <ul>
 * <li>{@link #getSelectedChart selectedChart} : (sap.ui.core.ID | sap.ui.core.Control)</li>
 * <li>{@link #getFirstDimensionSelect firstDimensionSelect} : (sap.ui.core.ID | sap.m.Select)</li>
 * <li>{@link #getSecondDimensionSelect secondDimensionSelect} : (sap.ui.core.ID | sap.m.Select)</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
 * <li>{@link #event:personalizationPressed personalizationPressed} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * <li>{@link #event:firstDimensionKeySelected firstDimensionKeySelected} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * <li>{@link #event:secondDimensionKeySelected secondDimensionKeySelected} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * </ul>
 * </li>
 * </ul>
 * 
 ...
 * @returns {sap.ca.ui.charts.ChartToolBar} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:firstDimensionKeySelected firstDimensionKeySelected} event of this <code>sap.ca.ui.charts.ChartToolBar</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.charts.ChartToolBar</code> itself.
 * 
 * Event fired when a user selects an item from the first select box.
 * This event is providing the item selectedKey as parameter
 * 
 ...
 *            fnFunction The function to be called when the event occurs
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ca.ui.charts.ChartToolBar</code> itself
 * 
 * @returns {sap.ca.ui.charts.ChartToolBar} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:personalizationPressed personalizationPressed} event of this <code>sap.ca.ui.charts.ChartToolBar</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.charts.ChartToolBar</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:secondDimensionKeySelected secondDimensionKeySelected} event of this <code>sap.ca.ui.charts.ChartToolBar</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.charts.ChartToolBar</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:firstDimensionKeySelected firstDimensionKeySelected} event of this <code>sap.ca.ui.charts.ChartToolBar</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:personalizationPressed personalizationPressed} event of this <code>sap.ca.ui.charts.ChartToolBar</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:secondDimensionKeySelected secondDimensionKeySelected} event of this <code>sap.ca.ui.charts.ChartToolBar</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ca.ui.charts.ChartToolBar.prototype.fireFirstDimensionKeySelected = function(mParameters) { return new sap.ca.ui.charts.ChartToolBar(); };
 ...
 * 
 */
sap.ca.ui.charts.ChartToolBar.prototype.firePersonalizationPressed = function(mParameters) { return new sap.ca.ui.charts.ChartToolBar(); };
 ...
 * 
 */
sap.ca.ui.charts.ChartToolBar.prototype.fireSecondDimensionKeySelected = function(mParameters) { return new sap.ca.ui.charts.ChartToolBar(); };
 ...
 * 
 * Default value is <code>empty string</code>.
 * @returns {string} Value of property <code>chartTitle</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>empty string</code>.
 * @returns {string} Value of property <code>firstDimensionKeyPath</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>empty string</code>.
 * @returns {string} Value of property <code>firstDimensionPath</code>
 * 
 * @public
 * 
 */
...
/**
 * ID of the element which is the current target of the association {@link #getFirstDimensionSelect firstDimensionSelect}, or <code>null</code>.
 * 
 ...
 * 
 */
sap.ca.ui.charts.ChartToolBar.prototype.getFirstDimensionSelect = function() { return new sap.ui.core.ID(); };
 ...
 * 
 * Default value is <code>empty string</code>.
 * @returns {string} Value of property <code>firstDimensionTextPath</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>empty string</code>.
 * @returns {string} Value of property <code>secondDimensionKeyPath</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>empty string</code>.
 * @returns {string} Value of property <code>secondDimensionPath</code>
 * 
 * @public
 * 
 */
...
/**
 * ID of the element which is the current target of the association {@link #getSecondDimensionSelect secondDimensionSelect}, or <code>null</code>.
 * 
 * @returns {sap.ui.core.ID}
 * 
 * @public
 * 
 */
sap.ca.ui.charts.ChartToolBar.prototype.getSecondDimensionSelect = function() { return new sap.ui.core.ID(); };
 ...
 * 
 * Default value is <code>empty string</code>.
 * @returns {string} Value of property <code>secondDimensionTextPath</code>
 * 
 * @public
 * 
 */
...
/**
 * ID of the element which is the current target of the association {@link #getSelectedChart selectedChart}, or <code>null</code>.
 * 
 * @returns {sap.ui.core.ID}
 * 
 * @public
 * 
 */
sap.ca.ui.charts.ChartToolBar.prototype.getSelectedChart = function() { return new sap.ui.core.ID(); };
...
/**
 * Checks for the provided <code>sap.ui.core.Control</code> in the aggregation {@link #getCharts charts}.
 * and returns its index if found or -1 otherwise.
 * @param {sap.ui.core.Control}
 ...
 * @returns {sap.ui.core.Control} The removed chart or <code>null</code>
 * 
 * @public
 * 
 */
 ...
 * @param {sap.ui.core.ID | sap.m.Select} oFirstDimensionSelect ID of an element which becomes the new target of this firstDimensionSelect association; alternatively, an element instance may be given
 * @returns {sap.ca.ui.charts.ChartToolBar} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ca.ui.charts.ChartToolBar.prototype.setFirstDimensionSelect = function(oFirstDimensionSelect) { return new sap.ca.ui.charts.ChartToolBar(); };
 ...
 * @param {sap.ui.core.ID | sap.m.Select} oSecondDimensionSelect ID of an element which becomes the new target of this secondDimensionSelect association; alternatively, an element instance may be given
 * @returns {sap.ca.ui.charts.ChartToolBar} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ca.ui.charts.ChartToolBar.prototype.setSecondDimensionSelect = function(oSecondDimensionSelect) { return new sap.ca.ui.charts.ChartToolBar(); };
 ...
 * @param {sap.ui.core.ID | sap.ui.core.Control} oSelectedChart ID of an element which becomes the new target of this selectedChart association; alternatively, an element instance may be given
 * @returns {sap.ca.ui.charts.ChartToolBar} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ca.ui.charts.ChartToolBar.prototype.setSelectedChart = function(oSelectedChart) { return new sap.ca.ui.charts.ChartToolBar(); };
 ...
 * @param {sap.m.Bar} oToolBar The toolBar to set
 * @returns {sap.ca.ui.charts.ChartToolBar} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 ...
 * <li>{@link #getItems items} : object</li>
 * </ul>
 * </li>
 * </ul>
 * 
 ...
 * @returns {sap.ca.ui.charts.ClusterListItem} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
 ...
 * <li>{@link #getSecondAxis secondAxis} : any</li>
 * </ul>
 * </li>
 * <li>Aggregations
 * <ul>
 * <li>{@link #getScrollArea scrollArea} : sap.m.ScrollContainer</li>
 * </ul>
 * </li>
 * </ul>
 * 
 ...
 * @returns {sap.ca.ui.charts.CombinedChart} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
 ...
 * Data of the Chart
 * 
 * @returns {any} Value of property <code>data</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {any} Value of property <code>primaryAxis</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {any} Value of property <code>secondAxis</code>
 * 
 * @public
 * 
 */
 ...
 * @param {sap.m.ScrollContainer} oScrollArea The scrollArea to set
 * @returns {sap.ca.ui.charts.CombinedChart} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 ...
 * <li>{@link #getBarHeight barHeight} : int (default: 48)</li>
 * </ul>
 * </li>
 * <li>Aggregations
 * <ul>
 ...
 * <li>{@link #getVerticalArea verticalArea} : sap.m.VBox</li>
 * </ul>
 * </li>
 * </ul>
 * 
 ...
 * @returns {sap.ca.ui.charts.HorizontalBarChart} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
 ...
 * @returns {int} Value of property <code>barHeight</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>chart</code>.
 * @returns {string} Value of property <code>container</code>
 * 
 * @public
 * 
 */
 ...
 * @param {sap.viz.ui5.Bar} oHorizontalBarChart The horizontalBarChart to set
 * @returns {sap.ca.ui.charts.HorizontalBarChart} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 ...
 * @param {sap.m.ScrollContainer} oScroll The scroll to set
 * @returns {sap.ca.ui.charts.HorizontalBarChart} Reference to <code>this</code> in order to allow method chaining
 * 
 * @deprecated Since version 7.20.0. 
 * This method is deprecated now.
 ...
 * @param {sap.m.VBox} oVerticalArea The verticalArea to set
 * @returns {sap.ca.ui.charts.HorizontalBarChart} Reference to <code>this</code> in order to allow method chaining
 * 
 * @deprecated Since version 7.20.0. 
 * This method is deprecated now.
 ...
 * <li>{@link #getUseDelayedResize useDelayedResize} : boolean (default: false)</li>
 * </ul>
 * </li>
 * <li>Aggregations
 * <ul>
 * <li>{@link #getVertical vertical} : sap.m.VBox</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
 * <li>{@link #event:onDetailsSelected onDetailsSelected} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * </ul>
 * </li>
 * </ul>
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:onDetailsSelected onDetailsSelected} event of this <code>sap.ca.ui.charts.LineChart</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.charts.LineChart</code> itself.
 * 
 * Event fired when the details button is pressed on the selected Datapoint Popover
 * 
 * @param {object}
 ...
 *            fnFunction The function to be called when the event occurs
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ca.ui.charts.LineChart</code> itself
 * 
 * @returns {sap.ca.ui.charts.LineChart} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 * @deprecated Since version 1.0.0. 
 * Do not use as it will be removed in a future release.
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:onDetailsSelected onDetailsSelected} event of this <code>sap.ca.ui.charts.LineChart</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ca.ui.charts.LineChart.prototype.fireOnDetailsSelected = function(mParameters) { return new sap.ca.ui.charts.LineChart(); };
 ...
 * 
 * @returns {any} Value of property <code>chartBusinessData</code>
 * 
 * @deprecated Since version 1.0.0. 
 ...
 * 
 * @returns {any} Value of property <code>chartDataset</code>
 * 
 * @deprecated Since version 1.0.0. 
 ...
 * 
 * @returns {any} Value of property <code>chartDatasetSettings</code>
 * 
 * @deprecated Since version 1.0.0. 
 ...
 * 
 * @returns {string} Value of property <code>dataPath</code>
 * 
 * @deprecated Since version 1.0.0. 
 * Please use the binding on 'dataset', do not use as it will be removed in a future release.
 * 
 ...
 * 
 * @returns {any} Value of property <code>datasetSettings</code>
 * 
 * @deprecated Since version 1.0.0. 
 ...
 * 
 * Default value is <code>48px</code>.
 * @returns {string} Value of property <code>minTouchSize</code>
 * 
 * @deprecated Since version 1.0.0. 
 ...
 * 
 * Default value is <code>48px</code>.
 * @returns {string} Value of property <code>minTouchWidth</code>
 * 
 * @deprecated Since version 1.0.0. 
 ...
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>showScrollContext</code>
 * 
 * @deprecated Since version 1.0.0. 
 ...
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>useDelayedResize</code>
 * 
 * @deprecated Since version 1.0.0. 
 * Do not use as it will be removed in a future release.
 * 
 ...
 * @param {sap.m.VBox} oVertical The vertical to set
 * @returns {sap.ca.ui.charts.LineChart} Reference to <code>this</code> in order to allow method chaining
 * 
 * @deprecated Since version 1.0.0. 
 * Do not use as it will be removed in a future release.
 ...
 * <li>{@link #getDataLabelFormat dataLabelFormat} : any (default: [["##"]])</li>
 * </ul>
 * </li>
 * <li>Aggregations
 * <ul>
 ...
 * @param {sap.ui.core.Control}
 *            oContent The content to add; if empty, nothing is inserted
 * @returns {sap.ca.ui.charts.StackedHorizontalBarChart} Reference to <code>this</code> in order to allow method chaining
 * 
 ...
 * 
 * Default value is <code>48px</code>.
 * @returns {sap.ui.core.CSSSize} Value of property <code>minTouchSize</code>
 * 
 * @deprecated Since version 1.16.3. 
 * 
 ...
 * @param {sap.ui.core.Control}
 *            oContent The content to add; if empty, nothing is inserted
 * @returns {sap.ca.ui.charts.StackedVerticalColumnChart} Reference to <code>this</code> in order to allow method chaining
 * 
 * @deprecated Since version 1.16.3. 
 * 
 * content has been deprecated since 1.16.3. The only visible content in the chart now is the internalVizChart.
 ...
 * <li>{@link #getData data} : object</li>
 * <li>{@link #getContainer container} : string (default: chart)</li>
 * <li>{@link #getBarWidth barWidth} : int (default: 48)</li>
 * </ul>
 * </li>
 * <li>Aggregations
 * <ul>
 ...
 * @param {sap.ui.core.Control}
 *            oContent The content to add; if empty, nothing is inserted
 * @returns {sap.ca.ui.charts.VerticalBarChart} Reference to <code>this</code> in order to allow method chaining
 * 
 * @deprecated Since version 7.20.0. 
 * This method is deprecated now.
 * 
 ...
 * 
 * Default value is <code>48</code>.
 * @returns {int} Value of property <code>barWidth</code>
 * 
 * @public
 * 
 */
 ...
 * @param {sap.viz.ui5.Column} oVerticalBarChart The verticalBarChart to set
 * @returns {sap.ca.ui.charts.VerticalBarChart} Reference to <code>this</code> in order to allow method chaining
 * 
 * @deprecated Since version 7.20.0. 
 * This method is deprecated now.
 ...
 * <li>Events
 * <ul>
 * <li>{@link #event:customerSelected customerSelected} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * </ul>
 * </li>
 * </ul>
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:customerSelected customerSelected} event of this <code>sap.ca.ui.CustomerContext</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.CustomerContext</code> itself.
 * 
 * Fired when a customer is selected in the list. The fired customer can be empty in case the user press the cancel button while the Customer Context has been open using select()
 * 
 * @param {object}
 ...
 *            fnFunction The function to be called when the event occurs
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ca.ui.CustomerContext</code> itself
 * 
 * @returns {sap.ca.ui.CustomerContext} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:customerSelected customerSelected} event of this <code>sap.ca.ui.CustomerContext</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ca.ui.CustomerContext.prototype.fireCustomerSelected = function(mParameters) { return new sap.ca.ui.CustomerContext(); };
 ...
 * @returns {string} Value of property <code>customerIDProperty</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {string} Value of property <code>customerNameProperty</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {string} Value of property <code>dialogTitle</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {string} Value of property <code>distributionChannelNameProperty</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {string} Value of property <code>divisionNameProperty</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {string} Value of property <code>personalizationPageName</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {string} Value of property <code>salesOrganizationNameProperty</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>showSalesArea</code>
 * 
 * @public
 * 
 */
 ...
 * <li>{@link #getDivisionName divisionName} : string (default: DivisionName)</li>
 * </ul>
 * </li>
 * </ul>
 * 
 ...
 * and enriches it with the information contained in <code>oClassInfo</code>.
 * 
 * <code>oClassInfo</code> might contain the same kind of information as described in {@link sap.m.CustomListItem.extend}.
 * 
 * @param {string} sClassName Name of the class being created
 * @param {object} [oClassInfo] Object literal with information about the class
 * @param {function} [FNMetaImpl] Constructor function for the metadata object; if not given, it defaults to <code>sap.ui.core.ElementMetadata</code>
 ...
 * 
 * Default value is <code>CustomerID</code>.
 * @returns {string} Value of property <code>customerID</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>CustomerName</code>.
 * @returns {string} Value of property <code>customerName</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>DistributionChannelName</code>.
 * @returns {string} Value of property <code>distributionChannelName</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>DivisionName</code>.
 * @returns {string} Value of property <code>divisionName</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>SalesOrganizationName</code>.
 * @returns {string} Value of property <code>salesOrganizationName</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {sap.ca.ui.CustomerControlListItem} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
 ...
 * <li>{@link #getDateValue dateValue} : string</li>
 * </ul>
 * </li>
 * </ul>
 * 
 ...
 * 
 * @returns {string} Value of property <code>dateValue</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {sap.ca.ui.DatePicker} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
 ...
 * <li>Properties
 * <ul>
 * <li>{@link #getMaxLines maxLines} : int (default: 5)</li>
 * </ul>
 * </li>
 * </ul>
 * 
 ...
 * and enriches it with the information contained in <code>oClassInfo</code>.
 * 
 * <code>oClassInfo</code> might contain the same kind of information as described in {@link sap.m.FeedListItem.extend}.
 * 
 * @param {string} sClassName Name of the class being created
 * @param {object} [oClassInfo] Object literal with information about the class
 * @param {function} [FNMetaImpl] Constructor function for the metadata object; if not given, it defaults to <code>sap.ui.core.ElementMetadata</code>
 ...
 * @returns {sap.ca.ui.ExpansibleFeedListItem} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
 ...
 * <li>Events
 * <ul>
 * <li>{@link #event:deleteFile deleteFile} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * <li>{@link #event:renameFile renameFile} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * <li>{@link #event:uploadFile uploadFile} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * <li>{@link #event:fileUploadFailed fileUploadFailed} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * <li>{@link #event:beforeUploadFile beforeUploadFile} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * <li>{@link #event:saveClicked saveClicked} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * <li>{@link #event:cancelClicked cancelClicked} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * </ul>
 * </li>
 * </ul>
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:beforeUploadFile beforeUploadFile} event of this <code>sap.ca.ui.FileUpload</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.FileUpload</code> itself.
 * 
 * Fired just before the control is about to make a file upload request. The data passed is the file object selected by the user. You may handle this event to attach custom headers for example if your service implementation requires it.
 * 
 * @param {object}
 ...
 *            fnFunction The function to be called when the event occurs
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ca.ui.FileUpload</code> itself
 * 
 * @returns {sap.ca.ui.FileUpload} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:cancelClicked cancelClicked} event of this <code>sap.ca.ui.FileUpload</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.FileUpload</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:deleteFile deleteFile} event of this <code>sap.ca.ui.FileUpload</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.FileUpload</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:fileUploadFailed fileUploadFailed} event of this <code>sap.ca.ui.FileUpload</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.FileUpload</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:renameFile renameFile} event of this <code>sap.ca.ui.FileUpload</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.FileUpload</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:saveClicked saveClicked} event of this <code>sap.ca.ui.FileUpload</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.FileUpload</code> itself.
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:uploadFile uploadFile} event of this <code>sap.ca.ui.FileUpload</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.FileUpload</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:beforeUploadFile beforeUploadFile} event of this <code>sap.ca.ui.FileUpload</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:cancelClicked cancelClicked} event of this <code>sap.ca.ui.FileUpload</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:deleteFile deleteFile} event of this <code>sap.ca.ui.FileUpload</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:fileUploadFailed fileUploadFailed} event of this <code>sap.ca.ui.FileUpload</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:renameFile renameFile} event of this <code>sap.ca.ui.FileUpload</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:saveClicked saveClicked} event of this <code>sap.ca.ui.FileUpload</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:uploadFile uploadFile} event of this <code>sap.ca.ui.FileUpload</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ca.ui.FileUpload.prototype.fireBeforeUploadFile = function(mParameters) { return new sap.ca.ui.FileUpload(); };
 ...
 * 
 */
sap.ca.ui.FileUpload.prototype.fireCancelClicked = function(mParameters) { return new sap.ca.ui.FileUpload(); };
 ...
 * 
 */
sap.ca.ui.FileUpload.prototype.fireDeleteFile = function(mParameters) { return new sap.ca.ui.FileUpload(); };
 ...
 * 
 */
sap.ca.ui.FileUpload.prototype.fireFileUploadFailed = function(mParameters) { return new sap.ca.ui.FileUpload(); };
 ...
 * 
 */
sap.ca.ui.FileUpload.prototype.fireRenameFile = function(mParameters) { return new sap.ca.ui.FileUpload(); };
 ...
 * 
 */
sap.ca.ui.FileUpload.prototype.fireSaveClicked = function(mParameters) { return new sap.ca.ui.FileUpload(); };
 ...
 * 
 */
sap.ca.ui.FileUpload.prototype.fireUploadFile = function(mParameters) { return new sap.ca.ui.FileUpload(); };
 ...
 * @returns {string} Value of property <code>acceptRequestHeader</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {boolean} Value of property <code>deleteEnabled</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>editMode</code>
 * 
 * @deprecated Since version 1.21.0. 
 ...
 * 
 * @returns {string} Value of property <code>encodeUrl</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {string} Value of property <code>fileId</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {string} Value of property <code>items</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>true</code>.
 * @returns {boolean} Value of property <code>multipleSelectionEnabled</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {boolean} Value of property <code>renameEnabled</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>sequentialUploadsEnabled</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>true</code>.
 * @returns {boolean} Value of property <code>showAttachmentsLabel</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>true</code>.
 * @returns {boolean} Value of property <code>showAttachmentsLabelInEditMode</code>
 * 
 * @deprecated Since version 1.21.0. 
 ...
 * 
 * @returns {string} Value of property <code>size</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>useEditControls</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {string} Value of property <code>xsrfToken</code>
 * 
 * @public
 * 
 */
 ...
 * @param {sap.m.Label} oAttachmentNumberLabel The attachmentNumberLabel to set
 * @returns {sap.ca.ui.FileUpload} Reference to <code>this</code> in order to allow method chaining
 * 
 * @deprecated Since version 1.21.0. 
 * This aggregation is deprecatd now. The label is part of the ToolBar
 ...
 * @param {sap.m.Label} oUploadProgressLabel The uploadProgressLabel to set
 * @returns {sap.ca.ui.FileUpload} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 ...
 * and enriches it with the information contained in <code>oClassInfo</code>.
 * 
 * <code>oClassInfo</code> might contain the same kind of information as described in {@link sap.m.ScrollContainer.extend}.
 * 
 * @param {string} sClassName Name of the class being created
 * @param {object} [oClassInfo] Object literal with information about the class
 * @param {function} [FNMetaImpl] Constructor function for the metadata object; if not given, it defaults to <code>sap.ui.core.ElementMetadata</code>
 ...
 * @returns {sap.ca.ui.GrowingTileContainer} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
 ...
 * <li>Aggregations
 * <ul>
 * <li>{@link #getItems items} : sap.ca.ui.HierarchicalSelectDialogItem[] (default)</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
 ...
 * @returns {sap.ca.ui.HierarchicalSelectDialog} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:cancel cancel} event of this <code>sap.ca.ui.HierarchicalSelectDialog</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.HierarchicalSelectDialog</code> itself.
 * 
 * Thrown when user clicks cancel
 * 
 * @param {object}
 ...
 *            fnFunction The function to be called when the event occurs
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ca.ui.HierarchicalSelectDialog</code> itself
 * 
 * @returns {sap.ca.ui.HierarchicalSelectDialog} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:select select} event of this <code>sap.ca.ui.HierarchicalSelectDialog</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.HierarchicalSelectDialog</code> itself.
 * 
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:cancel cancel} event of this <code>sap.ca.ui.HierarchicalSelectDialog</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:select select} event of this <code>sap.ca.ui.HierarchicalSelectDialog</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ca.ui.HierarchicalSelectDialog.prototype.fireCancel = function(mParameters) { return new sap.ca.ui.HierarchicalSelectDialog(); };
 ...
 * 
 */
sap.ca.ui.HierarchicalSelectDialog.prototype.fireSelect = function(mParameters) { return new sap.ca.ui.HierarchicalSelectDialog(); };
 ...
 * 
 * @returns {sap.ca.ui.HierarchicalSelectDialogItem[]}
 * 
 * @public
 * 
 */
...
/**
 * Checks for the provided <code>sap.ca.ui.HierarchicalSelectDialogItem</code> in the aggregation {@link #getItems items}.
 * and returns its index if found or -1 otherwise.
 * @param {sap.ca.ui.HierarchicalSelectDialogItem}
 ...
 * 
 * Additionally, it unregisters them from the hosting UIArea.
 * @returns {sap.ca.ui.HierarchicalSelectDialogItem[]} An array of the removed elements (might be empty)
 * 
 * @public
 * 
 */
 ...
 * @returns {sap.ca.ui.HierarchicalSelectDialogItem} The removed item or <code>null</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {sap.ca.ui.HierarchicalSelectDialogItem} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {string} Value of property <code>entityName</code>
 * 
 * @public
 * 
 */
 ...
 * <li>Properties
 * <ul>
 * <li>{@link #getHideOptionalLevels hideOptionalLevels} : boolean (default: true)</li>
 * </ul>
 * </li>
 * <li>Aggregations
 * <ul>
 * <li>{@link #getItems items} : sap.ca.ui.HierarchyItem[]</li>
 * </ul>
 * </li>
 * </ul>
 * 
 ...
 *            oItem The item to add; if empty, nothing is inserted
 * @returns {sap.ca.ui.Hierarchy} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
 ...
 * 
 */
sap.ca.ui.Hierarchy.prototype.bindItems = function(oBindingInfo) { return new sap.ca.ui.Hierarchy(); };
 ...
 * 
 * Default value is <code>true</code>.
 * @returns {boolean} Value of property <code>hideOptionalLevels</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * @returns {sap.ca.ui.HierarchyItem[]}
 * 
 * @public
 * 
 */
...
/**
 * Checks for the provided <code>sap.ca.ui.HierarchyItem</code> in the aggregation {@link #getItems items}.
 * and returns its index if found or -1 otherwise.
 * @param {sap.ca.ui.HierarchyItem}
 *           oItem The item whose index is looked for
 * @returns {int} The index of the provided control in the aggregation if found, or -1 otherwise
 ...
 * 
 * Additionally, it unregisters them from the hosting UIArea.
 * @returns {sap.ca.ui.HierarchyItem[]} An array of the removed elements (might be empty)
 * 
 * @public
 * 
 */
 ...
 * @returns {sap.ca.ui.HierarchyItem} The removed item or <code>null</code>
 * 
 * @public
 * 
 */
 ...
 * <li>{@link #getOptional optional} : boolean (default: false)</li>
 * </ul>
 * </li>
 * <li>Aggregations
 * <ul>
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:linkPress linkPress} event of this <code>sap.ca.ui.HierarchyItem</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.HierarchyItem</code> itself.
 * 
 * Event when a link is pressed
 * 
 * @param {object}
 ...
 *            fnFunction The function to be called when the event occurs
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ca.ui.HierarchyItem</code> itself
 * 
 * @returns {sap.ca.ui.HierarchyItem} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:linkPress linkPress} event of this <code>sap.ca.ui.HierarchyItem</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ca.ui.HierarchyItem.prototype.fireLinkPress = function(mParameters) { return new sap.ca.ui.HierarchyItem(); };
 ...
 * Identifier text
 * 
 * @returns {string} Value of property <code>identifier</code>
 * 
 * @public
 * 
 */
 ...
 * Level type
 * 
 * @returns {string} Value of property <code>levelType</code>
 * 
 * @public
 * 
 */
 ...
 * Text of the link
 * 
 * @returns {string} Value of property <code>link</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>optional</code>
 * 
 * @public
 * 
 */
 ...
 * <li>{@link #getUndoEnabled undoEnabled} : boolean (default: false)</li>
 * </ul>
 * </li>
 * <li>Aggregations
 * <ul>
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:change change} event of this <code>sap.ca.ui.InPlaceEdit</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.InPlaceEdit</code> itself.
 * 
 * Event is fired when the text in the field has changed AND the focus leaves the InPlaceEdit or the Enter key is pressed.
 * 
 * @param {object}
 ...
 *            fnFunction The function to be called when the event occurs
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ca.ui.InPlaceEdit</code> itself
 * 
 * @returns {sap.ca.ui.InPlaceEdit} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:change change} event of this <code>sap.ca.ui.InPlaceEdit</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ca.ui.InPlaceEdit.prototype.fireChange = function(mParameters) { return new sap.ca.ui.InPlaceEdit(); };
 ...
 * 
 */
sap.ca.ui.InPlaceEdit.prototype.setValueState = function(sValueState) { return new sap.ca.ui.InPlaceEdit(); };
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:addNote addNote} event of this <code>sap.ca.ui.Notes</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.Notes</code> itself.
 * 
 * press event for button
 * 
 * (oControlEvent) Event is fired when the user clicks on the control.
 ...
 *            fnFunction The function to be called when the event occurs
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ca.ui.Notes</code> itself
 * 
 * @returns {sap.ca.ui.Notes} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:addNote addNote} event of this <code>sap.ca.ui.Notes</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ca.ui.Notes.prototype.fireAddNote = function(mParameters) { return new sap.ca.ui.Notes(); };
 ...
 * 
 * Default value is <code>true</code>.
 * @returns {boolean} Value of property <code>showNoteInput</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {int} Value of property <code>textMaxLength</code>
 * 
 * @public
 * 
 */
 ...
 * @param {sap.ui.core.Control}
 *            oContent The content to add; if empty, nothing is inserted
 * @returns {sap.ca.ui.OverflowContainer} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
 ...
 * @returns {sap.ui.core.CSSSize} Value of property <code>overflowHeight</code>
 * 
 * @public
 * 
 */
 ...
 * <li>{@link #getContactActive contactActive} : boolean (default: false)</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
 * <li>{@link #event:contactPress contactPress} : fnListenerFunction or [fnListenerFunction, oListenerObject] or [oData, fnListenerFunction, oListenerObject]</li>
 * </ul>
 * </li>
 * </ul>
 * 
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:contactPress contactPress} event of this <code>sap.ca.ui.OverviewTile</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.OverviewTile</code> itself.
 * 
 * This event is fired when the end user clicks on the contact link.
 * 
 * @param {object}
 ...
 *            fnFunction The function to be called when the event occurs
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ca.ui.OverviewTile</code> itself
 * 
 * @returns {sap.ca.ui.OverviewTile} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:contactPress contactPress} event of this <code>sap.ca.ui.OverviewTile</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ca.ui.OverviewTile.prototype.fireContactPress = function(mParameters) { return new sap.ca.ui.OverviewTile(); };
 ...
 * @returns {string} Value of property <code>address</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>null</code>.
 * @returns {string} Value of property <code>contact</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>contactActive</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>null</code>.
 * @returns {string} Value of property <code>lastContact</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>null</code>.
 * @returns {string} Value of property <code>nextContact</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>null</code>.
 * @returns {string} Value of property <code>opportunities</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>null</code>.
 * @returns {string} Value of property <code>rating</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>null</code>.
 * @returns {string} Value of property <code>revenue</code>
 * 
 * @public
 * 
 */
 ...
 * <li>{@link #getHeight height} : sap.ui.core.CSSSize (default: 62px)</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:loaded loaded} event of this <code>sap.ca.ui.PictureItem</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.PictureItem</code> itself.
 * 
 * Fired when the Image is really loaded
 * 
 * @param {object}
 ...
 *            fnFunction The function to be called when the event occurs
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ca.ui.PictureItem</code> itself
 * 
 * @returns {sap.ca.ui.PictureItem} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:loaded loaded} event of this <code>sap.ca.ui.PictureItem</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ca.ui.PictureItem.prototype.fireLoaded = function(mParameters) { return new sap.ca.ui.PictureItem(); };
 ...
 * <li>Associations
 * <ul>
 * <li>{@link #getTileContent tileContent} : (sap.ui.core.ID | sap.ca.ui.PictureViewerItem)</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:pictureDelete pictureDelete} event of this <code>sap.ca.ui.PictureTile</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.PictureTile</code> itself.
 * 
 * Fired when the user deletes a picture
 * 
 * @param {object}
 ...
 *            fnFunction The function to be called when the event occurs
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ca.ui.PictureTile</code> itself
 * 
 * @returns {sap.ca.ui.PictureTile} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:pictureDelete pictureDelete} event of this <code>sap.ca.ui.PictureTile</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ca.ui.PictureTile.prototype.firePictureDelete = function(mParameters) { return new sap.ca.ui.PictureTile(); };
 ...
 * 
 */
sap.ca.ui.PictureTile.prototype.getTileContent = function() { return new sap.ui.core.ID(); };
 ...
 * <li>Aggregations
 * <ul>
 * <li>{@link #getItems items} : sap.ca.ui.PictureViewerItem[] (default)</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
...
/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:pictureDeleted pictureDeleted} event of this <code>sap.ca.ui.PictureViewer</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ca.ui.PictureViewer</code> itself.
 * 
 * Thrown when user delete an image
 * 
 * @param {object}
 ...
 *            fnFunction The function to be called when the event occurs
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ca.ui.PictureViewer</code> itself
 * 
 * @returns {sap.ca.ui.PictureViewer} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
...
/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:pictureDeleted pictureDeleted} event of this <code>sap.ca.ui.PictureViewer</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ca.ui.PictureViewer.prototype.firePictureDeleted = function(mParameters) { return new sap.ca.ui.PictureViewer(); };
 ...
 * control.
 * 
 * @returns {sap.ca.ui.PictureViewerItem[]}
 * 
 * @public
 * 
 */
...
/**
 * Checks for the provided <code>sap.ca.ui.PictureViewerItem</code> in the aggregation {@link #getItems items}.
 * and returns its index if found or -1 otherwise.
 * @param {sap.ca.ui.PictureViewerItem}
 *           oItem The item whose index is looked for
 * @returns {int} The index of the provided control in the aggregation if found, or -1 otherwise
 ...
 * 
 * Additionally, it unregisters them from the hosting UIArea.
 * @returns {sap.ca.ui.PictureViewerItem[]} An array of the removed elements (might be empty)
 * 
 * @public
 * 
 */
 ...
 * @returns {sap.ca.ui.PictureViewerItem} The removed item or <code>null</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {sap.ca.ui.PictureViewerItem} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
 ...
 * <li>{@link #getMaxScale maxScale} : float (default: 4)</li>
 * </ul>
 * </li>
 * </ul>
 * 
 ...
 * @returns {float} Value of property <code>initialScale</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {float} Value of property <code>maxScale</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>1</code>.
 * @returns {float} Value of property <code>minScale</code>
 * 
 * @public
 * 
 */
 ...
 * 
 * Default value is <code>true</code>.
 * @returns {boolean} Value of property <code>zoomable</code>
 * 
 * @public
 * 
 */
 ...
 * @returns {sap.ca.ui.ZoomableScrollContainer} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
 ...
 * 
 */
sap.ca.ui.charts.ChartSelectionMode.Multiple = "";
 ...
 * 
 */
sap.ca.ui.charts.ChartSelectionMode.None = "";
 ...
 * 
 */
sap.ca.ui.charts.ChartSelectionMode.Single = "";
 ...
 * 
 */
sap.ca.ui.charts.ChartSemanticColor.Bad = "";
 ...
 * 
 */
sap.ca.ui.charts.ChartSemanticColor.BadDark = "";
 ...
 * 
 */
sap.ca.ui.charts.ChartSemanticColor.BadLight = "";
 ...
 * 
 */
sap.ca.ui.charts.ChartSemanticColor.Critical = "";
 ...
 * 
 */
sap.ca.ui.charts.ChartSemanticColor.CriticalDark = "";
 ...
 * 
 */
sap.ca.ui.charts.ChartSemanticColor.CriticalLight = "";
 ...
 * 
 */
sap.ca.ui.charts.ChartSemanticColor.Good = "";
 ...
 * 
 */
sap.ca.ui.charts.ChartSemanticColor.GoodDark = "";
 ...
 * 
 */
sap.ca.ui.charts.ChartSemanticColor.GoodLight = "";
 ...
 * 
 */
sap.ca.ui.charts.ChartSemanticColor.Neutral = "";
 ...
 * 
 */
sap.ca.ui.charts.ChartSemanticColor.NeutralDark = "";
 ...
 * 
 */
sap.ca.ui.charts.ChartSemanticColor.NeutralLight = "";
