 ...
 * @public
 * 
 * @memberof sap.ui.fl.apply.api.ControlVariantApplyAPI
 */
sap.ui.fl.apply.api.ControlVariantApplyAPI.activateVariant = function(mPropertyBag) { return null; };
 ...
 * @memberof sap.ui.fl.apply.api.ControlVariantApplyAPI
 */
sap.ui.fl.apply.api.ControlVariantApplyAPI.clearVariantParameterInURL = function(mPropertyBag) {  };
 ...
 * 
 */
sap.ui.fl.transport.TransportSelection.prototype._prepareChangesForTransport = function(oTransportInfo,aAllLocalChanges,aAppVariantDescriptors,oContentParameters) { return null; };
 ...
 * <li>{@link #getResetOnContextChange resetOnContextChange} : boolean (default: true)</li>
 * </ul>
 * </li>
 * <li>Associations
 * <ul>
 ...
 * @param {sap.ui.base.EventProvider} oControlEvent.getSource
 * @param {object} oControlEvent.getParameters
 * @param {string} oControlEvent.getParameters.name Variant title
 ...
 * @param {string} oControlEvent.getParameters.key Variant key
 * @param {boolean} oControlEvent.getParameters.execute <i>Apply Automatically</i> indicator
 ...
 * 
 * @param {object} [mParameters] Parameters to pass along with the event
 * @param {string} [mParameters.name] Variant title
 * @param {boolean} [mParameters.overwrite] Indicates if an existing variant is overwritten or if a new variant is created.
 * @param {string} [mParameters.key] Variant key
 * @param {boolean} [mParameters.execute] <i>Apply Automatically</i> indicator
 ...
 * 
 * Default value is <code>true</code>.
 * @returns {boolean} Value of property <code>resetOnContextChange</code>
 * 
 * @public
 * 
 */
sap.ui.fl.variants.VariantManagement.prototype.getResetOnContextChange = function() { return false; };
 ...
 * 
 * Default value is <code>true</code>.
 * @param {boolean} bResetOnContextChange New value for property <code>resetOnContextChange</code>
 * @returns {sap.ui.fl.variants.VariantManagement} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ui.fl.variants.VariantManagement.prototype.setResetOnContextChange = function(bResetOnContextChange) { return new sap.ui.fl.variants.VariantManagement(); };
 ...
 * @public
 * 
 * @memberof sap.ui.fl.write.api.FeaturesAPI
 */
sap.ui.fl.write.api.FeaturesAPI.isKeyUser = function() { return new Promise.<boolean>(); };
 ...
 * @memberof sap.ui.fl.write.api.FeaturesAPI
 */
sap.ui.fl.write.api.FeaturesAPI.isPublishAvailable = function() { return new Promise.<boolean>(); };
