 ...
 * 
 */
sap.ushell.components.factsheet.controls.PictureViewer.prototype.deletePicture = function(iIndex) { return new sap.ushell.components.factsheet.controls.PictureViewer(); };
 ...
 * 
 */
sap.ushell.components.factsheet.controls.PictureViewer.prototype.selectPicture = function(iIndex) { return new sap.ushell.components.factsheet.controls.PictureViewer(); };
 ...
 * 
 */
sap.ushell.renderers.fiori2.Renderer.prototype.addFloatingButton = function(oParameters) { return new Object(); };
 ...
 * 
 */
sap.ushell.renderers.fiori2.Renderer.prototype.addShellSubHeader = function(oParameters) { return new Object(); };
 ...
 * 
 */
sap.ushell.renderers.fiori2.Renderer.prototype.addSidePaneContent = function(oParameters) { return new Object(); };
 ...
 * 
 */
sap.ushell.renderers.fiori2.Renderer.prototype.addUserAction = function(oParameters) { return new Object(); };
 ...
 * 
 */
sap.ushell.renderers.fiori2.Renderer.prototype.removeToolAreaItem = function(vIds,bCurrentState,aStates) {  };
 ...
 * 
 */
sap.ushell.renderers.fiori2.Renderer.prototype.setShellFooter = function(oParameters) { return new Object(); };
 ...
 * 
 */
sap.ushell.renderers.fiori2.Renderer.prototype.showActionButton = function(aIds,bCurrentState,aStates) {  };
 ...
 * 
 */
sap.ushell.renderers.fiori2.Renderer.prototype.showToolAreaItem = function(vIds,bCurrentState,aStates) {  };


// ---- sap.ushell.services --------------------------------------------------------------------------

// dummy function to make Eclipse aware of namespace
sap.ushell.services.toString = function() { return ""; };
 ...
 * 
 */
sap.ushell.services.Configuration = function() {};
 ...
 * 
 */
sap.ushell.services.Container = function(oAdapter) {};
/**
 ...
 * 
 */
sap.ushell.services.Container.prototype.addRemoteSystem = function(oRemoteSystem) {  };
 ...
 * 
 */
sap.ushell.services.Container.prototype.attachLogoutEvent = function(fnFunction) {  };
 ...
 * 
 */
sap.ushell.services.Container.prototype.attachRendererCreatedEvent = function(fnFunction) {  };
 ...
 * 
 */
sap.ushell.services.Container.prototype.cancelLogon = function() {  };
 ...
 * 
 */
sap.ushell.services.Container.prototype.createRenderer = function(sRendererName,bAsync) { return new sap.ui.core.Control(); };
 ...
 * 
 */
sap.ushell.services.Container.prototype.deregisterDirtyStateProvider = function(fnDirty) {  };
 ...
 * 
 */
sap.ushell.services.Container.prototype.detachLogoutEvent = function(fnFunction) {  };
 ...
 * 
 */
sap.ushell.services.Container.prototype.detachRendererCreatedEvent = function(fnFunction) {  };
 ...
 * 
 */
sap.ushell.services.Container.prototype.getDirtyFlag = function() { return false; };
 ...
 * 
 */
sap.ushell.services.Container.prototype.getService = function(sServiceName,sParameter,bAsync) { return new Object(); };
 ...
 * 
 */
sap.ushell.services.Container.prototype.getServiceAsync = function(sServiceName,sParameter) { return null; };
 ...
 * 
 */
sap.ushell.services.Container.prototype.registerDirtyStateProvider = function(fnDirty) {  };
 ...
 * 
 */
sap.ushell.services.Container.prototype.setDirtyFlag = function(bIsDirty) {  };
 ...
 * 
 */
sap.ushell.services.Container.prototype.setLogonFrameProvider = function(oLogonFrameProvider) {  };
 ...
 * 
 */
sap.ushell.services.LaunchPage.prototype.getCatalogTileKeywords = function(oCatalogTile) { return new Array(); };
 ...
 * 
 */
sap.ushell.services.LaunchPage.prototype.getCatalogTileTags = function(oCatalogTile) { return new Array(); };
 ...
 * 
 */
sap.ushell.services.LaunchPage.prototype.getGroups = function() { return new Promise.<object>(); };
 ...
 * 
 */
sap.ushell.services.LaunchPage.prototype.isGroupFeatured = function(oGroup) { return false; };
 ...
 * 
 */
sap.ushell.services.LaunchPage.prototype.removeTile = function(oGroup,oTile,iIndex) { return new Object(); };
 ...
 * 
 */
sap.ushell.services.LaunchPage.prototype.setGroupTitle = function(oGroup,sTitle) { return new Object(); };
 ...
 * 
 */
sap.ushell.services.NavTargetResolution = function(oServiceConfiguration) {};
/**
 ...
 * 
 */
sap.ushell.services.NavTargetResolution.prototype.resolveTarget = function(oArgs) { return new jQuery.Promise(); };
 ...
 * 
 */
sap.ushell.services.Notifications.prototype.dismissNotification = function(sNotificationId) { return null; };
 ...
 * 
 */
sap.ushell.services.Notifications.prototype.executeBulkAction = function(sNotificationGroupId,sActionId) { return null; };
 ...
 * 
 */
sap.ushell.services.Notifications.prototype.getNotificationsCount = function() { return 0.0; };
 ...
 * 
 */
sap.ushell.services.Notifications.prototype.isFirstDataLoaded = function() { return false; };
 ...
 * 
 */
sap.ushell.services.Notifications.prototype.markRead = function(sNotificationId) { return null; };
 ...
 * 
 */
sap.ushell.services.Notifications.prototype.registerNotificationCountUpdateCallback = function(callback) {  };
 ...
 * 
 */
sap.ushell.services.Notifications.prototype.registerNotificationsUpdateCallback = function(callback) {  };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer = function(sId,mSettings) {};
/**
 * @event
 * 
 * @param {sap.ui.base.Event} oControlEvent
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.afterRendering = function(oControlEvent) {  };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.layoutChange = function(oControlEvent) {  };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.tileDragEnter = function(oControlEvent) {  };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.tileDragStart = function(oControlEvent) {  };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.tileDrop = function(oControlEvent) {  };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.titleChange = function(oControlEvent) {  };
 ...
 * @returns {sap.ushell.ui.launchpad.GridContainer} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.addAfterContent = function(oAfterContent) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.addBeforeContent = function(oBeforeContent) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.addFooterContent = function(oFooterContent) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.addHeaderAction = function(oHeaderAction) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.addLink = function(oLink) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.addTile = function(oTile) { return new sap.ushell.ui.launchpad.GridContainer(); };

/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:afterRendering afterRendering} event of this <code>sap.ushell.ui.launchpad.GridContainer</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ushell.ui.launchpad.GridContainer</code> itself.
 * 
 * @param {object}
 *            [oData] An application-specific payload object that will be passed to the event handler along with the event object when firing the event
 * @param {function}
 *            fnFunction The function to be called when the event occurs
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ushell.ui.launchpad.GridContainer</code> itself
 * 
 * @returns {sap.ushell.ui.launchpad.GridContainer} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.attachAfterRendering = function(oData,fnFunction,oListener) { return new sap.ushell.ui.launchpad.GridContainer(); };

/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:layoutChange layoutChange} event of this <code>sap.ushell.ui.launchpad.GridContainer</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ushell.ui.launchpad.GridContainer</code> itself.
 * 
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.attachLayoutChange = function(oData,fnFunction,oListener) { return new sap.ushell.ui.launchpad.GridContainer(); };

/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:tileDragEnter tileDragEnter} event of this <code>sap.ushell.ui.launchpad.GridContainer</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ushell.ui.launchpad.GridContainer</code> itself.
 * 
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.attachTileDragEnter = function(oData,fnFunction,oListener) { return new sap.ushell.ui.launchpad.GridContainer(); };

/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:tileDragStart tileDragStart} event of this <code>sap.ushell.ui.launchpad.GridContainer</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ushell.ui.launchpad.GridContainer</code> itself.
 * 
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.attachTileDragStart = function(oData,fnFunction,oListener) { return new sap.ushell.ui.launchpad.GridContainer(); };

/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:tileDrop tileDrop} event of this <code>sap.ushell.ui.launchpad.GridContainer</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ushell.ui.launchpad.GridContainer</code> itself.
 * 
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.attachTileDrop = function(oData,fnFunction,oListener) { return new sap.ushell.ui.launchpad.GridContainer(); };

/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:titleChange titleChange} event of this <code>sap.ushell.ui.launchpad.GridContainer</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ushell.ui.launchpad.GridContainer</code> itself.
 * 
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.attachTitleChange = function(oData,fnFunction,oListener) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.destroyAfterContent = function() { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.destroyBeforeContent = function() { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.destroyFooterContent = function() { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.destroyHeaderActions = function() { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.destroyLinks = function() { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.destroyTiles = function() { return new sap.ushell.ui.launchpad.GridContainer(); };

/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:afterRendering afterRendering} event of this <code>sap.ushell.ui.launchpad.GridContainer</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.detachAfterRendering = function(fnFunction,oListener) { return new sap.ushell.ui.launchpad.GridContainer(); };

/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:layoutChange layoutChange} event of this <code>sap.ushell.ui.launchpad.GridContainer</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.detachLayoutChange = function(fnFunction,oListener) { return new sap.ushell.ui.launchpad.GridContainer(); };

/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:tileDragEnter tileDragEnter} event of this <code>sap.ushell.ui.launchpad.GridContainer</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.detachTileDragEnter = function(fnFunction,oListener) { return new sap.ushell.ui.launchpad.GridContainer(); };

/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:tileDragStart tileDragStart} event of this <code>sap.ushell.ui.launchpad.GridContainer</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.detachTileDragStart = function(fnFunction,oListener) { return new sap.ushell.ui.launchpad.GridContainer(); };

/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:tileDrop tileDrop} event of this <code>sap.ushell.ui.launchpad.GridContainer</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.detachTileDrop = function(fnFunction,oListener) { return new sap.ushell.ui.launchpad.GridContainer(); };

/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:titleChange titleChange} event of this <code>sap.ushell.ui.launchpad.GridContainer</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.detachTitleChange = function(fnFunction,oListener) { return new sap.ushell.ui.launchpad.GridContainer(); };

/**
 * Creates a new subclass of class sap.ushell.ui.launchpad.GridContainer with name <code>sClassName</code>
 * and enriches it with the information contained in <code>oClassInfo</code>.
 * 
 * <code>oClassInfo</code> might contain the same kind of information as described in {@link sap.ui.core.Control.extend}.
 * 
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.extend = function(sClassName,oClassInfo,FNMetaImpl) { return function() {}; };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.fireAfterRendering = function(mParameters) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.fireLayoutChange = function(mParameters) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.fireTileDragEnter = function(mParameters) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.fireTileDragStart = function(mParameters) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.fireTileDrop = function(mParameters) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.fireTitleChange = function(mParameters) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getAfterContent = function() { return new Array(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getBeforeContent = function() { return new Array(); };

/**
 * Gets current value of property {@link #getDefaultGroup defaultGroup}.
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>defaultGroup</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getDefaultGroup = function() { return false; };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getEditMode = function() { return false; };

/**
 * Gets current value of property {@link #getEnableHelp enableHelp}.
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>enableHelp</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getEnableHelp = function() { return false; };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getFooterContent = function() { return new Array(); };

/**
 * Gets current value of property {@link #getGroupHeaderLevel groupHeaderLevel}.
 * 
 * Default value is <code>H4</code>.
 * @returns {sap.m.HeaderLevel} Value of property <code>groupHeaderLevel</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getGroupHeaderLevel = function() { return new sap.m.HeaderLevel(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getGroupId = function() { return ""; };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getHeaderActions = function() { return new Array(); };

/**
 * Gets current value of property {@link #getHeaderLevel headerLevel}.
 * 
 * Default value is <code>H2</code>.
 * @returns {sap.m.HeaderLevel} Value of property <code>headerLevel</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getHeaderLevel = function() { return new sap.m.HeaderLevel(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getHeaderText = function() { return ""; };

/**
 * Gets current value of property {@link #getHomePageGroupDisplay homePageGroupDisplay}.
 * 
 * @returns {string} Value of property <code>homePageGroupDisplay</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getHomePageGroupDisplay = function() { return ""; };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getIcon = function() { return ""; };

/**
 * Gets current value of property {@link #getIeHtml5DnD ieHtml5DnD}.
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>ieHtml5DnD</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getIeHtml5DnD = function() { return false; };

/**
 * Gets current value of property {@link #getIsGroupLocked isGroupLocked}.
 * 
 * @returns {boolean} Value of property <code>isGroupLocked</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getIsGroupLocked = function() { return false; };

/**
 * Gets current value of property {@link #getIsGroupSelected isGroupSelected}.
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>isGroupSelected</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getIsGroupSelected = function() { return false; };

/**
 * Gets current value of property {@link #getIsLastGroup isLastGroup}.
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>isLastGroup</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getIsLastGroup = function() { return false; };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getLinks = function() { return new Array(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.getMetadata = function() { return new sap.ui.base.Metadata(); };

/**
 * Gets current value of property {@link #getShowBackground showBackground}.
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>showBackground</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getShowBackground = function() { return false; };

/**
 * Gets current value of property {@link #getShowEmptyLinksArea showEmptyLinksArea}.
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>showEmptyLinksArea</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getShowEmptyLinksArea = function() { return false; };

/**
 * Gets current value of property {@link #getShowEmptyLinksAreaPlaceHolder showEmptyLinksAreaPlaceHolder}.
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>showEmptyLinksAreaPlaceHolder</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getShowEmptyLinksAreaPlaceHolder = function() { return false; };

/**
 * Gets current value of property {@link #getShowGroupHeader showGroupHeader}.
 * 
 * Default value is <code>true</code>.
 * @returns {boolean} Value of property <code>showGroupHeader</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getShowGroupHeader = function() { return false; };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getShowHeader = function() { return false; };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getShowIcon = function() { return false; };

/**
 * Gets current value of property {@link #getSupportLinkPersonalization supportLinkPersonalization}.
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>supportLinkPersonalization</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getSupportLinkPersonalization = function() { return false; };

/**
 * Gets current value of property {@link #getTileActionModeActive tileActionModeActive}.
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>tileActionModeActive</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getTileActionModeActive = function() { return false; };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getTiles = function() { return new Array(); };

/**
 * Gets current value of property {@link #getTileSizeBehavior tileSizeBehavior}.
 * 
 * Default value is <code>TILE_SIZE_BEHAVIOR.RESPONSIVE</code>.
 * @returns {string} Value of property <code>tileSizeBehavior</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.getTileSizeBehavior = function() { return ""; };

/**
 * Checks for the provided <code>sap.ui.core.Control</code> in the aggregation {@link #getAfterContent afterContent}.
 * and returns its index if found or -1 otherwise.
 * @param {sap.ui.core.Control}
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.indexOfAfterContent = function(oAfterContent) { return 0; };

/**
 * Checks for the provided <code>sap.ui.core.Control</code> in the aggregation {@link #getBeforeContent beforeContent}.
 * and returns its index if found or -1 otherwise.
 * @param {sap.ui.core.Control}
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.indexOfBeforeContent = function(oBeforeContent) { return 0; };

/**
 * Checks for the provided <code>sap.ui.core.Control</code> in the aggregation {@link #getFooterContent footerContent}.
 * and returns its index if found or -1 otherwise.
 * @param {sap.ui.core.Control}
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.indexOfFooterContent = function(oFooterContent) { return 0; };

/**
 * Checks for the provided <code>sap.ui.core.Control</code> in the aggregation {@link #getHeaderActions headerActions}.
 * and returns its index if found or -1 otherwise.
 * @param {sap.ui.core.Control}
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.indexOfHeaderAction = function(oHeaderAction) { return 0; };

/**
 * Checks for the provided <code>sap.ui.core.Control</code> in the aggregation {@link #getLinks links}.
 * and returns its index if found or -1 otherwise.
 * @param {sap.ui.core.Control}
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.indexOfLink = function(oLink) { return 0; };

/**
 * Checks for the provided <code>sap.ui.core.Control</code> in the aggregation {@link #getTiles tiles}.
 * and returns its index if found or -1 otherwise.
 * @param {sap.ui.core.Control}
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.indexOfTile = function(oTile) { return 0; };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.insertAfterContent = function(oAfterContent,iIndex) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.insertBeforeContent = function(oBeforeContent,iIndex) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.insertFooterContent = function(oFooterContent,iIndex) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.insertHeaderAction = function(oHeaderAction,iIndex) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.insertLink = function(oLink,iIndex) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.insertTile = function(oTile,iIndex) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * @returns {sap.ui.core.Control} The removed afterContent or <code>null</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.removeAfterContent = function(vAfterContent) { return new sap.ui.core.Control(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.removeAllAfterContent = function() { return new Array(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.removeAllBeforeContent = function() { return new Array(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.removeAllFooterContent = function() { return new Array(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.removeAllHeaderActions = function() { return new Array(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.removeAllLinks = function() { return new Array(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.removeAllTiles = function() { return new Array(); };
 ...
 * @returns {sap.ui.core.Control} The removed beforeContent or <code>null</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.removeBeforeContent = function(vBeforeContent) { return new sap.ui.core.Control(); };
 ...
 * @returns {sap.ui.core.Control} The removed footerContent or <code>null</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.removeFooterContent = function(vFooterContent) { return new sap.ui.core.Control(); };
 ...
 * @returns {sap.ui.core.Control} The removed headerAction or <code>null</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.removeHeaderAction = function(vHeaderAction) { return new sap.ui.core.Control(); };
 ...
 * @returns {sap.ui.core.Control} The removed link or <code>null</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.removeLink = function(vLink) { return new sap.ui.core.Control(); };
 ...
 * @returns {sap.ui.core.Control} The removed tile or <code>null</code>
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.removeTile = function(vTile) { return new sap.ui.core.Control(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setDefaultGroup = function(bDefaultGroup) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setEditMode = function(bEditMode) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setEnableHelp = function(bEnableHelp) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 * Default value is <code>H4</code>.
 * @param {sap.m.HeaderLevel} sGroupHeaderLevel New value for property <code>groupHeaderLevel</code>
 * @returns {sap.ushell.ui.launchpad.GridContainer} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setGroupHeaderLevel = function(sGroupHeaderLevel) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setGroupId = function(sGroupId) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 * Default value is <code>H2</code>.
 * @param {sap.m.HeaderLevel} sHeaderLevel New value for property <code>headerLevel</code>
 * @returns {sap.ushell.ui.launchpad.GridContainer} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setHeaderLevel = function(sHeaderLevel) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setHeaderText = function(sHeaderText) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.
 * 
 * @param {string} sHomePageGroupDisplay New value for property <code>homePageGroupDisplay</code>
 * @returns {sap.ushell.ui.launchpad.GridContainer} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setHomePageGroupDisplay = function(sHomePageGroupDisplay) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setIcon = function(sIcon) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setIeHtml5DnD = function(bIeHtml5DnD) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setIsGroupLocked = function(bIsGroupLocked) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 * Default value is <code>false</code>.
 * @param {boolean} bIsGroupSelected New value for property <code>isGroupSelected</code>
 * @returns {sap.ushell.ui.launchpad.GridContainer} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setIsGroupSelected = function(bIsGroupSelected) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setIsLastGroup = function(bIsLastGroup) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setShowBackground = function(bShowBackground) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 * Default value is <code>false</code>.
 * @param {boolean} bShowEmptyLinksArea New value for property <code>showEmptyLinksArea</code>
 * @returns {sap.ushell.ui.launchpad.GridContainer} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setShowEmptyLinksArea = function(bShowEmptyLinksArea) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 * Default value is <code>false</code>.
 * @param {boolean} bShowEmptyLinksAreaPlaceHolder New value for property <code>showEmptyLinksAreaPlaceHolder</code>
 * @returns {sap.ushell.ui.launchpad.GridContainer} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setShowEmptyLinksAreaPlaceHolder = function(bShowEmptyLinksAreaPlaceHolder) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setShowGroupHeader = function(bShowGroupHeader) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setShowHeader = function(bShowHeader) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setShowIcon = function(bShowIcon) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 * Default value is <code>false</code>.
 * @param {boolean} bSupportLinkPersonalization New value for property <code>supportLinkPersonalization</code>
 * @returns {sap.ushell.ui.launchpad.GridContainer} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setSupportLinkPersonalization = function(bSupportLinkPersonalization) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setTileActionModeActive = function(bTileActionModeActive) { return new sap.ushell.ui.launchpad.GridContainer(); };
 ...
 * 
 * Default value is <code>TILE_SIZE_BEHAVIOR.RESPONSIVE</code>.
 * @param {string} sTileSizeBehavior New value for property <code>tileSizeBehavior</code>
 * @returns {sap.ushell.ui.launchpad.GridContainer} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ushell.ui.launchpad.GridContainer.prototype.setTileSizeBehavior = function(sTileSizeBehavior) { return new sap.ushell.ui.launchpad.GridContainer(); };
...
// dummy function to make Eclipse aware of namespace
sap.ushell.ui.tile.State.toString = function() { return ""; };

// ---- sap.ushell.ui.tile.StateArrow --------------------------------------------------------------------------

// dummy function to make Eclipse aware of namespace
sap.ushell.ui.tile.StateArrow.toString = function() { return ""; };
 ...
 * 
 */
sap.ushell.ui.tile.State.Critical = "";
 ...
 * 
 */
sap.ushell.ui.tile.State.Error = "";
 ...
 * 
 */
sap.ushell.ui.tile.State.Negative = "";
 ...
 * 
 */
sap.ushell.ui.tile.State.Neutral = "";
 ...
 * 
 */
sap.ushell.ui.tile.State.Positive = "";
 ...
 * 
 */
sap.ushell.ui.tile.State.Success = "";
 ...
 * 
 */
sap.ushell.ui.tile.State.Warning = "";
 ...
 * 
 */
sap.ushell.ui.tile.StateArrow.Down = "";
 ...
 * 
 */
sap.ushell.ui.tile.StateArrow.None = "";
 ...
 * 
 */
sap.ushell.ui.tile.StateArrow.Up = "";
